...
public class MainController {
	...
	public ModelAndView main() {
		ModelAndView mv = new ModelAndView("index"); // 보여주고자 하는 페이지를 입력
...
//	하나씩 받아오는 방법	
//	public ModelAndView signEnroll(@RequestParam("email") String email, @RequestParam("pin") String pw, @RequestParam("name") String name, @RequestParam("tel") String tel) {
//		ModelAndView mv = new ModelAndView("index");
